                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <ul class="arrow">
                                ...
                                <li><a href="<?php echo e(route('client.list')); ?>">Clients</a></li>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <ul class="arrow">
                                ...
                                <li><a href="<?php echo e(route('client.list')); ?>">Partner</a></li>
...
</div><?php /**PATH D:\PAYROLL\Payroll\EMS\resources\views/Frontend/partials/footer.blade.php ENDPATH**/ ?>