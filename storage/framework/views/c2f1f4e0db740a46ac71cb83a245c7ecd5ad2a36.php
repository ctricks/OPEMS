...
<div class="shadow p-4 d-flex justify-content-between align-items-center ">
    ...
    <div>
        <a href="<?php echo e(route('salary.view')); ?>" class="btn btn-success p-2 text-lg rounded-pill"><i
        ...
        <div>
            <div class="w-75 mx-auto">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('salary.store.data')); ?>" method="post" id="salaryForm">
                            <?php echo csrf_field(); ?>
                            <div class="row mb-4">
                                <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-4">
                                    ...
                                    <div class="mt-2">
                                        <?php $__errorArgs = ['medical_expenses'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mt-2">
                                        <?php $__errorArgs = ['mobile_allowance'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mt-2">
                                        <?php $__errorArgs = ['houseRent_allowance'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PAYROLL\Payroll\EMS\resources\views/admin/pages/Salary/createSalary.blade.php ENDPATH**/ ?>