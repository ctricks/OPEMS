...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('admin-assets/css/datetimepicker.css')); ?>">
...
<body class="hold-transition sidebar-mini">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link p-0 pr-3 avatar p-1" data-toggle="dropdown" href="#">
                        <img src="<?php echo e(isset(auth()->user()->employee) && auth()->user()->employee->employee_image ? url('/uploads//' . auth()->user()->employee->employee_image) : asset('assests/image/default.png')); ?>"
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-3">
                        ...
                        <div class="  text-gray-700">
                            <h6 class="text-uppercase font-weight-bold"><?php echo e(auth()->user()->name); ?></h6><small
                                class="text-uppercase"><?php echo e(auth()->user()->role); ?></small>
                        </div>


                        <div class="dropdown-divider" style="margin-top: 15px"></div>
                        <a href="<?php echo e(route('admin.logout')); ?>" class="text-danger" style="margin-top: 15px">
    ...
    <script src=<?php echo e(asset('admin-assets/js/datetimepicker.js')); ?>></script>
    ...
    <?php echo $__env->yieldPushContent('yourJsCode'); ?>
    </script>
    <?php echo $__env->yieldContent('customJs'); ?>
</body>

</html><?php /**PATH D:\PAYROLL\Payroll\EMS\resources\views/admin/master.blade.php ENDPATH**/ ?>